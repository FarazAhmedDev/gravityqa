...
export default function ValidationBuilder({ validations, onChange }: Props) {
    ...
    const validationTypes = [
        { value: 'status', label: 'Status Code', icon: '✓' },
        { value: 'time', label: 'Response Time', icon: '⏱️' },
        ...
        <div style={{
            ...
            <div style={{
                ...
                <button
                    ...
                    style={{
                        ...
                        fontWeight: '600',
                        cursor: 'pointer',
                        boxShadow: `0 4px 12px ${swaggerTheme.primary}40`,
            ...
            {validations.length === 0 ? (
                <div style={{
                    ...
                    borderRadius: '10px',
                    border: `2px dashed ${swaggerTheme.border}`
                }}>
                        ...
                        <div key={validation.id} style={{
                            ...
                            <div style={{
                                ...
                                <button
                                    ...
                                    style={{
                                        padding: '10px 12px',
                                        background: swaggerTheme.error + '20',
                                        border: `1px solid ${swaggerTheme.error}`,
                                        borderRadius: '6px',
                                    ...
                                    onMouseEnter={(e) => {
                                        e.currentTarget.style.background = swaggerTheme.error
                                        e.currentTarget.style.color = 'white'
                                    }}
                                    onMouseLeave={(e) => {
                                        e.currentTarget.style.background = swaggerTheme.error + '20'
                                        e.currentTarget.style.color = swaggerTheme.error
                                    }}
                                >
                                    🗑️
                                </button>
