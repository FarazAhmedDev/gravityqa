...
export default function AutomationWizard() {
    ...
    const handleGenerateCode = async () => {
        ...
        try {
            ...
            // Auto-hide after 2 seconds and switch to editor
            setTimeout(() => {
            ...
            {showSuccessModal && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        borderRadius: '24px',
                        padding: '60px 80px',
                        boxShadow: '0 30px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(88,166,255,0.3)',
                        textAlign: 'center',
                        ...
                        <div style={{
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                            boxShadow: '0 0 40px rgba(46, 160, 67, 0.5), inset 0 2px 0 rgba(255,255,255,0.2)',
                        ...
                        {[...Array(6)].map((_, i) => (
                            <div key={i} style={{
                                ...
                                borderRadius: '50%',
                                opacity: 0,
                                animation: `particle${i % 3} 1.5s ease-out`,
                                top: '50%',
                                left: '50%'
                            }} />
                        ))}
                    ...
                    <style>{`
                        ...
                        @keyframes successPulse {
                            ...
                            50% { 
                                transform: scale(1.1); 
                                box-shadow: 0 0 60px rgba(46, 160, 67, 0.8); 
                            }
                        }
