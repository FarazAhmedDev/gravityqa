        ...
        >
            ...
            {particles.map(particle => (
                <div
                    ...
                    style={{
                        ...
                        pointerEvents: 'none',
                        boxShadow: `0 0 ${particle.size * 2}px ${colors.primary}40`
                    }}
                />
            ))}
            ...
            <div style={{
                ...
                <svg viewBox="0 0 1200 300" preserveAspectRatio="none" style={{ width: '100%', height: '100%' }}>
                    <path
                        d="M0,100 C300,200 400,0 600,100 C800,200 900,0 1200,100 L1200,300 L0,300 Z"
                        fill={colors.primary}
                        opacity="0.3"
                        style={{ animation: 'wave1 15s ease-in-out infinite' }}
                    />
                    <path
                        d="M0,150 C300,50 400,250 600,150 C800,50 900,250 1200,150 L1200,300 L0,300 Z"
                        fill={colors.cyan}
                        opacity="0.2"
            ...
            {/* [Previous content continues exactly the same...] */}
            <div style={{
                marginBottom: '32px',
                display: 'flex',
                alignItems: 'center',
            ...
            <style>{`
                ...
                @keyframes wave1 {
                    0%, 100% { d: path("M0,100 C300,200 400,0 600,100 C800,200 900,0 1200,100 L1200,300 L0,300 Z"); }
                    50% { d: path("M0,150 C300,50 400,250 600,150 C800,50 900,250 1200,150 L1200,300 L0,300 Z"); }
                }
                @keyframes wave2 {
                    0%, 100% { d: path("M0,150 C300,50 400,250 600,150 C800,50 900,250 1200,150 L1200,300 L0,300 Z"); }
                    50% { d: path("M0,100 C300,200 400,0 600,100 C800,200 900,0 1200,100 L1200,300 L0,300 Z"); }
                }
